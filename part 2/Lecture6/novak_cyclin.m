...
global k1 k3
k1 = 0; % Set k1 to 0 to inhibit synthesis
k3 = 0; % Set k3 to 0 to inhibit degradation
...
v2_1 = 0; % Set v2_1 to 0 to inhibit synthesis
v2_2 = 0; % Set v2_2 to 0 to inhibit degradation
% v25_1 = 0.5*0.017 ;
% v25_2 = 0.5*0.17 ;
v25_1 = 0.5*0.017 ;
v25_2 = 0.5*0.17 ;
...
CDK_total = 100 ;
% cdc25_total = 5 ;
cdc25_total = 5; % Modify the value of cdc25_total
